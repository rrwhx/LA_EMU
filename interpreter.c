...
static bool trans_crc_w_b_w(CPULoongArchState *env, arg_crc_w_b_w *a) {env->gpr[a->rd] = helper_crc32(env->gpr[a->rk], env->gpr[a->rj], 1);env->pc += 4;return true;}
static bool trans_crc_w_h_w(CPULoongArchState *env, arg_crc_w_h_w *a) {env->gpr[a->rd] = helper_crc32(env->gpr[a->rk], env->gpr[a->rj], 2);env->pc += 4;return true;}
static bool trans_crc_w_w_w(CPULoongArchState *env, arg_crc_w_w_w *a) {env->gpr[a->rd] = helper_crc32(env->gpr[a->rk], env->gpr[a->rj], 4);env->pc += 4;return true;}
static bool trans_crc_w_d_w(CPULoongArchState *env, arg_crc_w_d_w *a) {env->gpr[a->rd] = helper_crc32(env->gpr[a->rk], env->gpr[a->rj], 8);env->pc += 4;return true;}
static bool trans_crcc_w_b_w(CPULoongArchState *env, arg_crcc_w_b_w *a) {env->gpr[a->rd] = helper_crc32c(env->gpr[a->rk], env->gpr[a->rj], 1);env->pc += 4;return true;}
static bool trans_crcc_w_h_w(CPULoongArchState *env, arg_crcc_w_h_w *a) {env->gpr[a->rd] = helper_crc32c(env->gpr[a->rk], env->gpr[a->rj], 2);env->pc += 4;return true;}
static bool trans_crcc_w_w_w(CPULoongArchState *env, arg_crcc_w_w_w *a) {env->gpr[a->rd] = helper_crc32c(env->gpr[a->rk], env->gpr[a->rj], 4);env->pc += 4;return true;}
...
uint64_t helper_write_csr(CPULoongArchState *env, int csr_index, uint64_t new_v, uint64_t mask) {
    ...
    switch (csr_index) {
        ...
        case LOONGARCH_CSR_ASID           :old_v = env->CSR_ASID; env->CSR_ASID = mask_write(env->CSR_ASID, new_v, mask); cpu_clear_tc(env); break;
        ...
        case LOONGARCH_CSR_STLBPS         :old_v = env->CSR_STLBPS; env->CSR_STLBPS = mask_write(env->CSR_STLBPS, new_v, mask); cpu_clear_tc(env); break;
        ...
        case LOONGARCH_CSR_DMW(0)         :old_v = env->CSR_DMW[0]; env->CSR_DMW[0] = mask_write(env->CSR_DMW[0], new_v, mask); cpu_clear_tc(env); break;
        case LOONGARCH_CSR_DMW(1)         :old_v = env->CSR_DMW[1]; env->CSR_DMW[1] = mask_write(env->CSR_DMW[1], new_v, mask); cpu_clear_tc(env); break;
        case LOONGARCH_CSR_DMW(2)         :old_v = env->CSR_DMW[2]; env->CSR_DMW[2] = mask_write(env->CSR_DMW[2], new_v, mask); cpu_clear_tc(env); break;
        case LOONGARCH_CSR_DMW(3)         :old_v = env->CSR_DMW[3]; env->CSR_DMW[3] = mask_write(env->CSR_DMW[3], new_v, mask); cpu_clear_tc(env); break;
...
static bool trans_vmulwev_q_d(CPULoongArchState *env, arg_vmulwev_q_d *a) {
    int size = 16;
    int index = 0;
    CHECK_FPE(size);
...
static bool trans_vmulwod_q_d(CPULoongArchState *env, arg_vmulwod_q_d *a) {
    int size = 16;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmulwev_q_du(CPULoongArchState *env, arg_vmulwev_q_du *a) {
    int size = 16;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmulwod_q_du(CPULoongArchState *env, arg_vmulwod_q_du *a) {
    int size = 16;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmulwev_q_du_d(CPULoongArchState *env, arg_vmulwev_q_du_d *a) {
    int size = 16;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmulwod_q_du_d(CPULoongArchState *env, arg_vmulwod_q_du_d *a) {
    int size = 16;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmaddwev_q_d(CPULoongArchState *env, arg_vmaddwev_q_d *a) {
    int size = 16;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmaddwod_q_d(CPULoongArchState *env, arg_vmaddwod_q_d *a) {
    int size = 16;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmaddwev_q_du(CPULoongArchState *env, arg_vmaddwev_q_du *a) {
    int size = 16;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmaddwod_q_du(CPULoongArchState *env, arg_vmaddwod_q_du *a) {
    int size = 16;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmaddwev_q_du_d(CPULoongArchState *env, arg_vmaddwev_q_du_d *a) {
    int size = 16;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_vmaddwod_q_du_d(CPULoongArchState *env, arg_vmaddwod_q_du_d *a) {
    int size = 16;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmaddwev_q_d(CPULoongArchState *env, arg_xvmaddwev_q_d *a) {
    int size = 32;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmaddwod_q_d(CPULoongArchState *env, arg_xvmaddwod_q_d *a) {
    int size = 32;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmaddwev_q_du(CPULoongArchState *env, arg_xvmaddwev_q_du *a) {
    int size = 32;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmaddwod_q_du(CPULoongArchState *env, arg_xvmaddwod_q_du *a) {
    int size = 32;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmaddwev_q_du_d(CPULoongArchState *env, arg_xvmaddwev_q_du_d *a) {
    int size = 32;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmaddwod_q_du_d(CPULoongArchState *env, arg_xvmaddwod_q_du_d *a) {
    int size = 32;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmulwev_q_d(CPULoongArchState *env, arg_xvmulwev_q_d *a) {
    int size = 32;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmulwod_q_d(CPULoongArchState *env, arg_xvmulwod_q_d *a) {
    int size = 32;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmulwev_q_du(CPULoongArchState *env, arg_xvmulwev_q_du *a) {
    int size = 32;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmulwod_q_du(CPULoongArchState *env, arg_xvmulwod_q_du *a) {
    int size = 32;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmulwev_q_du_d(CPULoongArchState *env, arg_xvmulwev_q_du_d *a) {
    int size = 32;
    int index = 0;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
...
static bool trans_xvmulwod_q_du_d(CPULoongArchState *env, arg_xvmulwod_q_du_d *a) {
    int size = 32;
    int index = 1;
    CHECK_FPE(size);
    for (int i = 0; i < (size / 16); i++) {
